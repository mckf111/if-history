# 内容授权声明 / Content License

本仓库采用**双轨授权**：

## 一、代码（Code）—— AGPL-3.0

以下内容按 [GNU Affero General Public License v3.0](LICENSE) 授权：

- 全部 `.ts` / `.tsx` / `.css` 源码中的**程序逻辑**（引擎、状态机、界面组件、构建配置等）。
...
- 本仓库引用的《明史》《甲申传信录》《大明会典》等古籍属公有领域，不在上述授权范围内；
- 版权人保留对代码与内容进行**其他方式授权**（含商业授权）的一切权利（双重授权）；
- 商业合作请联系版权人。
