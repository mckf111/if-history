<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="《城破前夜：刻下无名》——1644 年北京城破前夜，一封假信沿着相信、行动与代价连成可追溯的因果链">
</p>

<p align="center">
  <strong><a href="https://if-history.caowenhu.com/">▶ 现在进城</a></strong>
  · <a href="#一封假信二十鞭">读一局真实结果</a>
  · <a href="#一局怎么走">一局怎么走</a>
  · <a href="#本地运行">本地运行</a>
</p>

<p align="center">
  <code>v0.6.0</code> · 免费个人非商业游玩 · 无注册 · 无广告 · 不上传存档 · 约 20～40 分钟
</p>
...
发布前最后一轮完整测评里，一封伪造的私信送进运夫营。姚春生信了，当夜翻墙想逃，被抓回来，挨了二十鞭。

事件节点是作者预先写进规则的；但从“做出假信”到“春生受罚”的完整因果链，不是固定播片，而是这一局的玩家操作、人物信念、概率判定和人物行动共同接成。终局会把每一步摊开：纸怎么做成、交给谁送、对方为什么信、信了以后做了什么。

<p align="center">
  <a href="./if-history-wechat-promo-v2/01_文章正文.md">
    <img src="./if-history-wechat-promo-v2/assets/封面图_2.35比1.png" width="100%" alt="公众号文章《游戏里一封假信写得太好，弟弟挨了二十鞭》封面：姚小满在夜里刻版，一根朱砂红线连接文书与城门">
  </a>
</p>

<p align="center">
  <strong><a href="./if-history-wechat-promo-v2/01_文章正文.md">读完整文章 →</a></strong>
  · <a href="https://if-history.caowenhu.com/">不看攻略，直接开局</a>
</p>
...
<p align="center">
  <img src="./assets/readme/workbench-desktop.png" width="72%" alt="刻坊工作台：选择断言、核对来源并确认制作文书">
  <img src="./assets/readme/ending-mobile.png" width="23%" alt="手机端结局：红绳过了水门，开局誓愿得到回应">
</p>
...
游戏没有账号、服务器数据库或运行时人工智能。自动存档、声音和跨局史鉴都留在浏览器本地；右下角“档”可以抄出或读回经过完整重放校验的 JSON 存档。
...
<details>
<summary><strong>开发与提交前检查</strong></summary>
...
- [公众号文章：游戏里一封假信写得太好，弟弟挨了二十鞭](if-history-wechat-promo-v2/01_文章正文.md)
- [公众号推广包 v2：正文、图片与质检归档](if-history-wechat-promo-v2/README.md)
